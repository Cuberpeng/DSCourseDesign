...
void LLMClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LLMClient::*)(const QString & )>(_a, &LLMClient::finished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (LLMClient::*)(const QString & )>(_a, &LLMClient::error, 1))
            return;
    }
}
...
// SIGNAL 0
void LLMClient::finished(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void LLMClient::error(const QString & _t1)
{
